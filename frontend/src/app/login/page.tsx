        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            ...
            >
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent">MedRemind</h1>
                    <p className="text-gray-500 mt-2">Sign in to manage your health</p>
                </div>
